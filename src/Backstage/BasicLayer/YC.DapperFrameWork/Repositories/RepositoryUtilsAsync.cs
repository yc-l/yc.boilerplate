...
namespace Dapper
{
    ...
    public static partial class RepositoryUtils
    {
        ...
        public static async Task<int> InsertListAsync<TKey, TEntity>(this IDbConnection connection, List<TEntity> entityToInsertList, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            count = await connection.ExecuteAsync(sb.ToString(), entityToInsertList, transaction, commandTimeout, CommandType.Text);
